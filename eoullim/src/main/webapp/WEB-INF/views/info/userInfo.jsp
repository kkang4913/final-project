...
<header class="header">
	...
	<div id="hoverTarget" class="header-img">
		<div id="imgSelect" class="img-grad-layer">
		</div>
		<div class="header-img">
			<img id="infoImg" class="header-img__img" src="${userInfo.infoImagePath}" accept="image/*">
		</div>
	</div>
	<!-- 프로필 -->
	<div class="header-info-box">
		...
		<div class="header-info-img">
			<img id="profImg" class="header-info-img__img icon--circle"  src="${userInfo.memberImagePath}" accept="image/*">
		</div>
		...
		<div class="header-info-detail">
			...
			<div class="header-info__column">
				<div class="icon__location">${userInfo.locationName}</div>
